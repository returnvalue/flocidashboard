...
def ec2_inventory() -> dict[str, Any]:
    ...
    return {
        ...
        'notes': [
            'RunInstances launches a Docker-backed local instance unless EC2 mock mode is enabled.',
            'DescribeImages returns a static list of common AMIs and Floci-native AMI IDs.',
