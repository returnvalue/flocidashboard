...
S3_ACTIONS = (
    ...
    action(
        ...
        'PUT',
        '/api/s3/buckets/{bucket}/website/',
        'update',
        fields=(action_field('configuration', 'Website configuration JSON', required=True, field_type='object'),),
        success_message='Website configuration saved',
    ),
    action(
        'delete_website',
        ...
        'delete',
        safety='destructive',
        confirm='Delete this website hosting configuration?',
        success_message='Website configuration deleted',
    ),
    action(
        'presign_object',
...
EC2_ACTIONS = (
    action(
        ...
        fields=(
            ...
            action_field('tags', 'Tags', field_type='json'),
        ),
    ...
    action(
        ...
        'Edit instance tags',
        'PUT',
        '/api/ec2/instances/{instance}/tags/',
        'update',
        fields=(action_field('tags', 'Tags', required=True, field_type='json'),),
        success_message='Instance tags updated',
    ),
    action(
        'run_instance_command',
        'Run shell command',
        'POST',
        '/api/ec2/instances/{instance}/commands/',
        'execute',
        fields=(
            action_field('command', 'Shell command', required=True, field_type='textarea'),
            action_field('timeout_seconds', 'Timeout seconds'),
        ),
        success_message='Command submitted',
    ),
    action(
        'import_key_pair',
        'Import key pair',
    ...
    action('create_vpc', 'Create VPC', 'POST', '/api/ec2/vpcs/', 'create', fields=(action_field('cidr_block', 'CIDR block', required=True), action_field('name', 'Name')), success_message='VPC created'),
    action('delete_vpc', 'Delete VPC', 'DELETE', '/api/ec2/vpcs/{vpc}/', 'delete', safety='destructive', confirm='Delete this VPC?', success_message='VPC deleted'),
    action('create_subnet', 'Create subnet', 'POST', '/api/ec2/subnets/', 'create', fields=(action_field('vpc_id', 'VPC ID', required=True), action_field('cidr_block', 'CIDR block', required=True), action_field('availability_zone', 'Availability zone'), action_field('name', 'Name')), success_message='Subnet created'),
    action('delete_subnet', 'Delete subnet', 'DELETE', '/api/ec2/subnets/{subnet}/', 'delete', safety='destructive', confirm='Delete this subnet?', success_message='Subnet deleted'),
    action('create_security_group', 'Create security group', 'POST', '/api/ec2/security-groups/', 'create', fields=(action_field('name', 'Group name', required=True), action_field('description', 'Description', required=True), action_field('vpc_id', 'VPC ID', required=True)), success_message='Security group created'),
    action('delete_security_group', 'Delete security group', 'DELETE', '/api/ec2/security-groups/{group}/', 'delete', safety='destructive', confirm='Delete this security group?', success_message='Security group deleted'),
    action('authorize_security_group_rule', 'Add security group rule', 'POST', '/api/ec2/security-groups/{group}/rules/', 'create', fields=(action_field('direction', 'Direction', required=True), action_field('rule', 'Rule', required=True, field_type='json')), success_message='Security group rule added'),
    action('revoke_security_group_rule', 'Remove security group rule', 'DELETE', '/api/ec2/security-groups/{group}/rules/', 'delete', safety='destructive', confirm='Remove this security group rule?', success_message='Security group rule removed'),
    action('create_internet_gateway', 'Create internet gateway', 'POST', '/api/ec2/internet-gateways/', 'create', success_message='Internet gateway created'),
    action('delete_internet_gateway', 'Delete internet gateway', 'DELETE', '/api/ec2/internet-gateways/{gateway}/', 'delete', safety='destructive', confirm='Delete this internet gateway?', success_message='Internet gateway deleted'),
    action('attach_internet_gateway', 'Attach internet gateway', 'PUT', '/api/ec2/internet-gateways/{gateway}/attachment/', 'update', fields=(action_field('vpc_id', 'VPC ID', required=True),), success_message='Internet gateway attached'),
    action('detach_internet_gateway', 'Detach internet gateway', 'DELETE', '/api/ec2/internet-gateways/{gateway}/attachment/', 'delete', safety='destructive', confirm='Detach this internet gateway?', fields=(action_field('vpc_id', 'VPC ID', required=True),), success_message='Internet gateway detached'),
    action('create_route_table', 'Create route table', 'POST', '/api/ec2/route-tables/', 'create', fields=(action_field('vpc_id', 'VPC ID', required=True),), success_message='Route table created'),
    action('delete_route_table', 'Delete route table', 'DELETE', '/api/ec2/route-tables/{route_table}/', 'delete', safety='destructive', confirm='Delete this route table?', success_message='Route table deleted'),
    action('associate_route_table', 'Associate route table', 'POST', '/api/ec2/route-tables/{route_table}/associations/', 'update', fields=(action_field('subnet_id', 'Subnet ID', required=True),), success_message='Route table associated'),
    action('disassociate_route_table', 'Disassociate route table', 'DELETE', '/api/ec2/route-tables/{route_table}/associations/', 'delete', safety='destructive', confirm='Disassociate this route table?', fields=(action_field('association_id', 'Association ID', required=True),), success_message='Route table disassociated'),
    action('create_route', 'Create route', 'POST', '/api/ec2/route-tables/{route_table}/routes/', 'create', fields=(action_field('destination_cidr', 'Destination CIDR', required=True), action_field('gateway_id', 'Gateway ID', required=True)), success_message='Route created'),
    action('delete_route', 'Delete route', 'DELETE', '/api/ec2/route-tables/{route_table}/routes/', 'delete', safety='destructive', confirm='Delete this route?', fields=(action_field('destination_cidr', 'Destination CIDR', required=True),), success_message='Route deleted'),
    action('allocate_elastic_ip', 'Allocate Elastic IP', 'POST', '/api/ec2/elastic-ips/', 'create', success_message='Elastic IP allocated'),
    action('release_elastic_ip', 'Release Elastic IP', 'DELETE', '/api/ec2/elastic-ips/{allocation}/', 'delete', safety='destructive', confirm='Release this Elastic IP?', success_message='Elastic IP released'),
    action('associate_elastic_ip', 'Associate Elastic IP', 'PUT', '/api/ec2/elastic-ips/{allocation}/association/', 'update', fields=(action_field('instance_id', 'Instance ID', required=True),), success_message='Elastic IP associated'),
    action('disassociate_elastic_ip', 'Disassociate Elastic IP', 'DELETE', '/api/ec2/elastic-ips/{allocation}/association/', 'delete', safety='destructive', confirm='Disassociate this Elastic IP?', fields=(action_field('association_id', 'Association ID', required=True),), success_message='Elastic IP disassociated'),
    action('create_nat_gateway', 'Create NAT gateway', 'POST', '/api/ec2/nat-gateways/', 'create', fields=(action_field('subnet_id', 'Subnet ID', required=True), action_field('allocation_id', 'Allocation ID', required=True), action_field('connectivity_type', 'Connectivity type')), success_message='NAT gateway created'),
    action('delete_nat_gateway', 'Delete NAT gateway', 'DELETE', '/api/ec2/nat-gateways/{nat_gateway}/', 'delete', safety='destructive', confirm='Delete this NAT gateway?', success_message='NAT gateway deleted'),
    action('create_vpc_endpoint', 'Create VPC endpoint', 'POST', '/api/ec2/vpc-endpoints/', 'create', fields=(action_field('vpc_id', 'VPC ID', required=True), action_field('service_name', 'Service name', required=True), action_field('endpoint_type', 'Endpoint type'), action_field('route_table_ids', 'Route table IDs', field_type='array'), action_field('subnet_ids', 'Subnet IDs', field_type='array'), action_field('security_group_ids', 'Security group IDs', field_type='array')), success_message='VPC endpoint created'),
    action('delete_vpc_endpoint', 'Delete VPC endpoint', 'DELETE', '/api/ec2/vpc-endpoints/{endpoint}/', 'delete', safety='destructive', confirm='Delete this VPC endpoint?', success_message='VPC endpoint deleted'),
    action('create_network_acl', 'Create network ACL', 'POST', '/api/ec2/network-acls/', 'create', fields=(action_field('vpc_id', 'VPC ID', required=True),), success_message='Network ACL created'),
    action('delete_network_acl', 'Delete network ACL', 'DELETE', '/api/ec2/network-acls/{network_acl}/', 'delete', safety='destructive', confirm='Delete this network ACL?', success_message='Network ACL deleted'),
    action('put_network_acl_entry', 'Add or replace ACL entry', 'PUT', '/api/ec2/network-acls/{network_acl}/entries/', 'update', fields=(action_field('entry', 'Entry', required=True, field_type='json'),), success_message='Network ACL entry saved'),
    action('delete_network_acl_entry', 'Delete ACL entry', 'DELETE', '/api/ec2/network-acls/{network_acl}/entries/', 'delete', safety='destructive', confirm='Delete this network ACL entry?', fields=(action_field('rule_number', 'Rule number', required=True), action_field('egress', 'Egress', field_type='boolean')), success_message='Network ACL entry deleted'),
    action('replace_network_acl_association', 'Replace ACL association', 'PUT', '/api/ec2/network-acls/{network_acl}/associations/', 'update', fields=(action_field('association_id', 'Association ID', required=True),), success_message='Network ACL association replaced'),
    action('create_flow_log', 'Create flow log', 'POST', '/api/ec2/flow-logs/', 'create', fields=(action_field('resource_id', 'Resource ID', required=True), action_field('resource_type', 'Resource type'), action_field('traffic_type', 'Traffic type'), action_field('destination', 'S3 destination ARN', required=True)), success_message='Flow log created'),
    action('delete_flow_log', 'Delete flow log', 'DELETE', '/api/ec2/flow-logs/{flow_log}/', 'delete', safety='destructive', confirm='Delete this flow log?', success_message='Flow log deleted'),
    action('create_volume', 'Create volume', 'POST', '/api/ec2/volumes/', 'create', fields=(action_field('availability_zone', 'Availability zone', required=True), action_field('size', 'Size GiB', required=True, field_type='number'), action_field('volume_type', 'Volume type'), action_field('encrypted', 'Encrypted', field_type='boolean'), action_field('tags', 'Tags', field_type='json')), success_message='Volume created'),
    action('delete_volume', 'Delete volume', 'DELETE', '/api/ec2/volumes/{volume}/', 'delete', safety='destructive', confirm='Delete this volume?', success_message='Volume deleted'),
    action('register_image', 'Register AMI', 'POST', '/api/ec2/images/', 'create', fields=(action_field('name', 'Name', required=True), action_field('description', 'Description'), action_field('architecture', 'Architecture'), action_field('root_device_name', 'Root device name'), action_field('block_device_mappings', 'Block device mappings', field_type='json')), success_message='AMI registered'),
    action('create_launch_template', 'Create launch template', 'POST', '/api/ec2/launch-templates/', 'create', fields=(action_field('name', 'Name', required=True), action_field('data', 'Launch data', required=True, field_type='json')), success_message='Launch template created'),
    action('delete_launch_template', 'Delete launch template', 'DELETE', '/api/ec2/launch-templates/{launch_template}/', 'delete', safety='destructive', confirm='Delete this launch template?', success_message='Launch template deleted'),
    action('create_launch_template_version', 'Create launch template version', 'POST', '/api/ec2/launch-templates/{launch_template}/versions/', 'create', fields=(action_field('source_version', 'Source version'), action_field('data', 'Launch data', required=True, field_type='json')), success_message='Launch template version created'),
    action('set_launch_template_default_version', 'Set default template version', 'PUT', '/api/ec2/launch-templates/{launch_template}/default-version/', 'update', fields=(action_field('version', 'Version', required=True),), success_message='Default launch template version updated'),
    action('request_spot_instances', 'Request Spot instances', 'POST', '/api/ec2/spot-requests/', 'create', fields=(action_field('image_id', 'AMI ID', required=True), action_field('instance_type', 'Instance type', required=True), action_field('spot_price', 'Spot price'), action_field('instance_count', 'Instance count', field_type='number'), action_field('subnet_id', 'Subnet ID'), action_field('security_group_ids', 'Security group IDs', field_type='array')), success_message='Spot request created'),
    action('cancel_spot_request', 'Cancel Spot request', 'POST', '/api/ec2/spot-requests/{spot_request}/cancel/', 'delete', safety='destructive', confirm='Cancel this Spot request?', success_message='Spot request cancelled'),
)
...
IAM_ACTIONS = (
    action(
        ...
        fields=(
            action_field('user_name', 'User name', required=True),
            action_field('add_baseline_policy', 'Add sts:GetCallerIdentity baseline policy', field_type='boolean'),
        ),
        success_message='User created',
    ),
    action(
        ...
        'delete',
        safety='destructive',
        confirm='Delete this IAM user and clean up its access keys, group memberships, and policies?',
    ...
    action(
        ...
        '/api/iam/groups/',
        'create',
        fields=(action_field('group_name', 'Group name', required=True),),
    ...
    action(
        ...
        'Clean up group',
        'DELETE',
        '/api/iam/groups/{group}/',
        'delete',
        safety='destructive',
        confirm='Delete this IAM group and clean up memberships and policies?',
        fields=(action_field('force', 'Confirm dependency cleanup', field_type='boolean'),),
    ...
    action(
        ...
        'create',
        fields=(
            action_field('role_name', 'Role name', required=True),
            action_field('trust_template', 'Trust template'),
            action_field('trust_policy', 'Trust policy JSON', field_type='textarea'),
        ),
    ...
    action(
        ...
        'delete',
        safety='destructive',
        confirm='Delete this IAM role and clean up policies and instance-profile links?',
        fields=(action_field('force', 'Confirm dependency cleanup', field_type='boolean'),),
    ...
    action(
        ...
        'POST',
        '/api/iam/instance-profiles/',
        'create',
        fields=(action_field('instance_profile_name', 'Instance profile name', required=True),),
        success_message='Instance profile created',
    ),
    action(
        'add_role_to_instance_profile',
        'Add role to instance profile',
        'POST',
        '/api/iam/instance-profiles/{instance_profile}/roles/',
        'update',
    ...
    action(
        ...
        'Test permission',
        'POST',
        '/api/iam/policy-simulation/',
        'read',
        safety='safe',
        fields=(
            action_field('principal_arn', 'Principal ARN', required=True),
            action_field('action_names', 'Action names', required=True, field_type='array'),
            action_field('resource_arns', 'Resource ARNs', field_type='array'),
        ),
        success_message='Permission tested',
    ),
    action(
        'create_access_key',
        'Create access key',
    ...
    action(
        ...
        'PUT',
        '/api/iam/principals/{principal_type}/{principal}/permissions-boundary/',
        'update',
        fields=(action_field('policy_arn', 'Boundary policy ARN', required=True),),
        success_message='Permissions boundary saved',
    ),
    action(
        ...
        'delete',
        safety='destructive',
        confirm='Clear this permissions boundary?',
        success_message='Permissions boundary cleared',
    ),
    action(
        'put_inline_policy',
        'Save inline policy',
...
SERVICES: tuple[ServiceDefinition, ...] = (
    ...
    service(
        'amazonmq',
        'Amazon MQ',
        'RabbitMQ-backed brokers, endpoints, and users',
        'Application Integration',
        maturity='interactive_workbench',
        console_css='dashboard/amazonmq-console.css',
        console_js='dashboard/amazonmq-console.js',
        shared_console=True,
        tags=('layered-workbench', 'message-broker-workbench'),
    ),
    service(
        'athena',
        'Athena',
    ...
    service(
        'costexplorer',
        'Cost Explorer',
        'Cost and usage breakdown, forecasts, and anomaly detection',
        'Management',
        maturity='interactive_workbench',
        console_css='dashboard/costexplorer-console.css',
        console_js='dashboard/costexplorer-console.js',
        shared_console=True,
        tags=('layered-workbench', 'cost-management-workbench'),
    ),
    ...
    service(
        'docdb',
        'DocumentDB',
        'MongoDB-compatible clusters, instances, and connection endpoints',
        'Database',
        maturity='interactive_workbench',
        docs_url='https://floci.io/floci/services/docdb/',
        console_css='dashboard/docdb-console.css',
        console_js='dashboard/docdb-console.js',
        shared_console=True,
        tags=('layered-workbench', 'document-database-workbench'),
    ),
    service(
        'memorydb',
        'MemoryDB',
        'Redis-compatible clusters, users, ACLs, and endpoints',
        'Database',
        maturity='interactive_workbench',
        console_css='dashboard/memorydb-console.css',
        console_js='dashboard/memorydb-console.js',
        shared_console=True,
        tags=('layered-workbench', 'in-memory-database-workbench'),
    ),
    service(
        'ec2',
        'EC2',
    ...
    service(
        'iot',
        'IoT Core',
        'Things, device certificates, policies, and MQTT message routing',
        'Application Integration',
        maturity='interactive_workbench',
        console_css='dashboard/iot-console.css',
    ...
    service(
        'pricing',
        'AWS Price List',
        'Pricing services, instance rates, and AWS cost calculator',
        'Management',
        maturity='interactive_workbench',
        console_css='dashboard/pricing-console.css',
        console_js='dashboard/pricing-console.js',
        shared_console=True,
        tags=('layered-workbench', 'pricing-calculator-workbench'),
    ),
    service(
        'rds',
        'RDS',
    ...
    service(
        's3vectors',
        'S3 Vectors',
        'Vector buckets, embeddings, and similarity search indexes',
        'Storage',
        maturity='interactive_workbench',
        console_css='dashboard/s3vectors-console.css',
        console_js='dashboard/s3vectors-console.js',
        shared_console=True,
        tags=('layered-workbench', 'vector-database-workbench'),
    ),
    service(
        'scheduler',
    ...
    service(
        ...
        console_css='dashboard/wafv2-console.css',
        console_js='dashboard/wafv2-console.js',
        shared_console=True,
        tags=('layered-workbench', 'waf-workbench'),
    ),
)
