"""
Django settings for flocidashboard project.
...
MIDDLEWARE = [
    ...
    'dashboard.middleware.RuntimeEndpointOverrideMiddleware',
...
ROOT_URLCONF = 'flocidashboard.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'dashboard.context_processors.static_versions',
            ],
        },
    },
]

WSGI_APPLICATION = 'flocidashboard.wsgi.application'
